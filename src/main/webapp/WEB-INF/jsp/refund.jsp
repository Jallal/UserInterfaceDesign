...
<nav class="navbar navbar-expand-lg navbar-light text-white">
    <div class="container-fluid">
        ...
        <br/>
        <a href="account" type="button" id="H" class="btn ummaize">
            <i class="fas fa-align-left"></i>
...
<div class="container">
    <div class="py-5 text-center">
        ...
        <p class="lead">You refund is the balance remaining after paying your dues for the semester. The information below is to verify your identity only</p>
    </div>
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                <span class="text-muted">Your running balance</span>
                <span class="badge badge-secondary badge-pill">3</span>
            </h4>
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0 text-info">Winter 2020 tuition</h6>
                        <small class="text-info">Tuition due for semester</small>
                    </div>
                    <span class="text-info">$6523.21</span>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0 text-warning">Payment Submitted</h6>
                        <small class="text-warning">Student Payment</small>
                    </div>
                    <span class="text-warning">-$6523.21</span>
                </li>
                <li class="list-group-item d-flex justify-content-between bg-light">
                    <div class="text-success">
                        <h6 class="my-0">Credit</h6>
                        <small>Credit for dropped classes</small>
                    </div>
                    <span class="text-success">+$2300.10</span>
                </li>
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total (USD)</span>
                    <strong>+$2300.10</strong>
                </li>
            </ul>
        </div>
        <div class="col-md-8 order-md-1">
            <h4 class="mb-3">Please Sign</h4>
